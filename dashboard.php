                 ...
                 <thead>
                    <tr>
                        <th scope="col">Vendor_Id</th>
                            ...
                            <th scope="col">Remove Vendors</th>
                     </tr>
                 </thead>
				 <tbody>
	<?php
...
<!--tab 1 ends-->	   
	...
	?>			 
                    ...
                    <tr>
						...
						<form method="post">
                        <td><a href="#"  style="text-decoration:none; color:white;" onclick="delRecord(<?php echo $row['fldvendor_id']; ?>)"><button type="button" class="btn btn-danger">Remove Supplier</a></a></td>
                        </form>
                   </tr>
		<?php
		}
