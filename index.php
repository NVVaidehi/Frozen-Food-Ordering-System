...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Frozen Food </span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item"><!--hotel search-->
		     <a href="#" class="nav-link"><form method="post"><input type="text" name="search_hotel" id="search_hotel" placeholder="Search Vendors " class="form-control " /></form></a>
		  </li>
          <li class="nav-item">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="pics\back2.jpg" alt="Los Angeles" class="d-block w-100" >
    ...
    <div class="carousel-item">
      <img src="pics\ff1.jpg" alt="Chicago" class="d-block w-100" >
      <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img src="pics\desserts1.webp" alt="New York" class="d-block w-100" >
      <div class="carousel-caption">
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-6">
	<div class="container-fluid">
	 <img src="pics\Frozen-berries-500x333.jpg" height="300px" width="100%" >
	</div>
	 <div class="container">
		 <br>
	 <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">With plenty of fiber and antioxidants, frozen berries are a nutrient-rich, low-calorie addition to many foods, such as oatmeal, yogurt, parfaits, smoothies, and even savory meat dishes. Freezing doesn't significantly diminish berries' nutrition.Freezing doesn’t significantly diminish berries’ nutrition. In fact, berries are harvested for freezing when they’re at the peak of freshness, so you can enjoy them all year round. Frozen berry blends may come with various combinations of berries, including strawberries, blueberries, raspberries, blackberries, and cherries. All of these bring significant health benefits.One cup of frozen berries (150g) provides 60 calories, 1g of protein, 15g of carbohydrates, and 0.5g of fat. Frozen berries are an excellent source of vitamin C and fiber. Frozen berries are a convenient way to enjoy the benefits of berries year-round. Berries are a healthy source of fiber and natural sugars, with plenty of nutrients like vitamin C, manganese, vitamin K, potassium, and zinc.</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	                                   ...
	                                   ?>
	                                      <div class="container-fluid">
	                                          <div class="container-fluid"><!--product row container 1-->
	                                               <div class="row" style="padding:10px; ">
		                            <!--logo-->  <div class="col-sm-2"><img src="<?php echo $hotel_logo; ?>" class="rounded-circle" height="50px" width="50px" alt="Cinque Terre"></div>
		                                               <div class="col-sm-5">
	   ...
	   <div class="col-sm-6">
	        <div class="container-fluid">
	             <img src="pics\back1.jpg" height="300px" width="100%"><!--image-->
	        </div>
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">In contrast to many other processed foods that gradually make up a chief part of western diets, frozen meat does not call for any harmful preservatives. It is an absolutely standard process that purely takes a reduction in temperature and packaging with minimum to zero preservatives.The freezing course of action can and does decrease potentially harmful bacteria, which can be the source of food poisoning. As long as you store up the food in the approved manner and follow directions for thawing and cooking, frozen meat is really safe.In all probability something you have never related with frozen meat is that you can help the globe. Purchasing frozen food means you can take fewer trips to get to the butcher shops, thereby dropping your individual carbon footprint.Research says that about meat contains large amounts of Calcium, Vitamin B12, B3 (Niacin), B6, Iron, Zinc, Selenium and ample of other vitamins and minerals. 
